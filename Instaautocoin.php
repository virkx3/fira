...
<body style='font-family: Yatra One;'>
 ...
 <center>
     <?php
error_reporting(0);
echo "<font color='red' size='5'><bold><hr class='hr-19'>InstaUP<hr class='hr-19'><bold>";
...
$tkv=md5($enc_data.':M3JGej58KVZIbC13KzVJMA==');
 ...
 $dx='[{"id":'.$id.',"liked_before":0,"order_id":"'.$oid.'","smartCommented":0,"smartLiked":0},{"id":'.$id1.',"liked_before":0,"order_id":"'.$oid1.'","smartCommented":0,"smartLiked":0}]';
...
<input type='text' name='uid'  class='text' placeholder='Enter Your instaup instagram-user ID' required><br><br>";
echo "<input type='submit' class='submit' name='submit' value='submit'>";
}
?>
 
<div id='formFooter'>
<center><script type="text/javascript">(function() {var script=document.createElement("script");script.type="text/javascript";script.async =true;script.src="//telegram.im/widget-button/index.php?id=@namastehackersnetwork";document.getElementsByTagName("head")[0].appendChild(script);})();</script>
<a href="tg://resolve?domain=namastegangnetwork" target="_blank" class="telegramim_button telegramim_shadow telegramim_pulse" style="font-size:30px;width:399px;background:#84ff00;box-shadow:1px 1px 5px #0b5394;color:#6f00ff;border-radius:100px;" title="Join Now"><i></i> join my channel to get more script and bypass tricks<small><span class='telegramim_count' data-for='@namastehackersnetwork'>...</span> participants</small></a>
</center>
<p>
